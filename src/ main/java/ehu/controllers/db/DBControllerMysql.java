...
public class DBControllerMysql {

    Connection conn=null;
    private static final DBControllerMysql controller = new DBControllerMysql();
    ...
    private DBControllerMysql() {
        this.conOpen();
    }

    public static DBControllerMysql getController() {
        return controller;
    }
